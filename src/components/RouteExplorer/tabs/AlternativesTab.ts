...
export class AlternativesTab {
  ...
  private renderEmpty(): void {
    setTrustedHtml(this.element, trustedHtml('<div class="re-tab__placeholder">برای دیدن مسیرهای جایگزین، مبدأ، مقصد و محصول را انتخاب کنید.</div>', "legacy direct innerHTML migration"));
  }

  private renderNoLane(): void {
    setTrustedHtml(this.element, trustedHtml('<div class="re-tab__empty"><p>مسیر مدل‌سازی‌شده‌ای وجود ندارد. مسیر جایگزین به یک مسیر اصلی نیاز دارد.</p></div>', "legacy direct innerHTML migration"));
  }

  private renderEmptyAlternatives(): void {
    setTrustedHtml(this.element, trustedHtml('<div class="re-tab__empty"><p>برای گلوگاه اصلی این مسیر، مسیر دریایی جایگزینی موجود نیست.</p></div>', "legacy direct innerHTML migration"));
  }
  ...
  private renderList(): void {
    ...
    listEl.setAttribute('aria-label', 'مسیرهای دریایی جایگزین');
