    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        return `
          ...
          <img class="brand-logo" src="/branding/rasadyar-logo.png" alt="رصدیار پدافند"><span class="logo">رصدیار پدافند</span><span class="logo-mobile">رصدیار پدافند</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">رصدیار پدافند</span>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">رصدیار پدافند</span>
        ...
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} رصدیار پدافند</span>
      </footer>
